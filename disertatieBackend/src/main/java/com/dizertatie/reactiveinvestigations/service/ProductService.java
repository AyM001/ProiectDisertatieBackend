...
public class ProductService {
    ...
    public void addReport(Long productId) {
        ...
        try {
            printStream = new PrintStream(new File("report"+productId+".txt"));
    ...
    public ProductModel addProducts(ProductModel productModel) {
        ProductModel productModel1 = new ProductModel();
        productModel1.setProductId(productModel.getProductId());
        productModel1.setProductType(productModel.getProductType());
        productModel1.setFirstName(productModel.getFirstName());
        productModel1.setLastName(productModel.getLastName());
        productModel1.setPhoneNr(productModel.getPhoneNr());
        if (!productModel1.getProductType().equals(CALL)) {
            productModel1.setCallDuration(NO_DURATION);
        } else {
            productModel1.setCallDuration(productModel.getCallDuration());
        }
        productModel1.setEmailAddress(generateRandomEmailAddress(productModel.getFirstName(), productModel.getLastName()));
        productModel1.setCoordinates(productModel.getCoordinates());
        productModel1.setDirection(productModel.getDirection());
        //productModel.setParticipant();
        productModel1.setTargetModel(productModel.getTargetModel());
        productsRepo.save(productModel);
